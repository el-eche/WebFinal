...
alert(BrowserDetect.browser+"  "+BrowserDetect.version+"  "+BrowserDetect.OS);
 ...
 $(document).ready(function(){
   ...
   <script type="text/javascript">
           ...
           <script type="text/javascript">
               function categorias(){
                   var cate=document.getElementById("caja").value;
                   alert(cate);
      ...
      tipo=per.getTipo();
       ...
       <%}%>   </div>
        ...
        <%if(tipo.equals(ti)){%>    
         ...
         <div id="otrootro" style=tion: ute;left: 100px;width: 600px;">   
          <a href="#" oncliJuegos();">Mis Compras de Juegos</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
ResultSet rs;     
        ...
        while(rs.next()){ %>           
            ...
            <tr><td><input type="submit" name="caja" id="caja" onclick="categorias();" class="button" value="<%=rs.getString("tipo")%>" 
